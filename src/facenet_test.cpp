    ...
    )
{
    ...
    while (1)
        ...
        if (is_recognizing)
            ...
            if (add_newpic() == 1)
                {
                printf("printfroduce_features()\n");
                produce_features();
                printf("printfroduce_features() done\n");
                is_putting_text = 1;
